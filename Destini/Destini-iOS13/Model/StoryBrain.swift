...
struct StoryBrain {
    ...
    var title: String { story[storyIndex].title }
    var choice1: String { story[storyIndex].choice1 }
    var choice2: String { story[storyIndex].choice2 }
    
    mutating func makeChoice(_ choice: String) {
        let currentStory = story[storyIndex]
